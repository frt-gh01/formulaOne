...
class FormulaOneTest {
    ...
    @Test
    @DisplayName("A car stopped should not move when time pass")
    fun testACarStoppedShouldNotMoveWhenTimePass() {
        val sector1 = Sector.turboSectorOf(10 * Kilometer)
        val sector2 = Sector.noTurboSectorOf(2 * Kilometer)
        val sector3 = Sector.noTurboSectorOf(30 * Kilometer)
        val track = Track.with(listOf<Sector>(sector1, sector2, sector3))
    ...
    @Test
    @DisplayName("A car running should move when time pass")
    fun testACarRunningShouldMoveWhenTimePass() {
        val sector1 = Sector.turboSectorOf(10 * Kilometer)
        val sector2 = Sector.noTurboSectorOf(2 * Kilometer)
        val sector3 = Sector.noTurboSectorOf(30 * Kilometer)
        val track = Track.with(listOf<Sector>(sector1, sector2, sector3))
        ...
        grandPrix.advanceTime(2 * Hour)

        assertEquals(200 * Kilometer, schumacher.traveledDistance())
    ...
    @Test
    @DisplayName("GrandPrix moves cars between sectors")
    fun testGrandPrixMovesCarsBetweenSectors() {
        val sector1 = Sector.turboSectorOf(10 * Kilometer)
        val sector2 = Sector.noTurboSectorOf(2 * Kilometer)
        val sector3 = Sector.noTurboSectorOf(30 * Kilometer)
        val track = Track.with(listOf<Sector>(sector1, sector2, sector3))
        ...
        val schumacher = schumacherCar()
        schumacher.speed(30 * (Kilometer / Hour))
        ...
        assertEquals(30 * Kilometer, grandPrix.locationOf(schumacher))
    ...
    @Test
    @DisplayName("Second Turbo increments speed by 10%")
    fun testSecondTurboIncrementsSpeedBy10Percent() {
        val sector1 = Sector.turboSectorOf(10 * Kilometer)
        ...
        assertEquals(110 * (Kilometer/Hour), schumacher.speed())
    }

    @Test
    @DisplayName("Third Turbo increments speed by 5%")
    fun testThirdTurboIncrementsSpeedBy5Percent() {
        val sector1 = Sector.turboSectorOf(10 * Kilometer)
        ...
        assertEquals(105 * (Kilometer/Hour), schumacher.speed())
    }

    @Test
    @DisplayName("After third Turbo increments speed by 0%")
    fun testAfterThirdTurboIncrementsSpeedBy0Percent() {
        val sector1 = Sector.turboSectorOf(10 * Kilometer)
